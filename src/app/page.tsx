...
export default function Home() {
  ...
  <div>
      ...
      <div className="mx-auto mt-32 mb-32 sm:mt-56  sm:mb-56 max-w-5xl">
        <div className="mt-12 px-6 lg:px-8"> 
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="mt-2 font-bold text-4xl text-gray-900 lg:text-5xl"> Start Chatting In Minutes </h2>
          <p className="mt-4 text-gray-600 text-lg">
            Chatting with your PDF is never easy without Quillens 
             </p>
        </div>
        </div>
        {/* Steps  */}
